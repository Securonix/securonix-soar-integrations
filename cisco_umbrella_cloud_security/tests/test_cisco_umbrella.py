...
from app.cisco_umbrella_cloud_security import CiscoUmbrellaCloudSecurity, _detect_type, _is_valid_ipv4, _is_valid_url, _is_valid_domain
...
class TestGetToken:
    ...
    def test_token_success(self):
        connector = CiscoUmbrellaCloudSecurity()
